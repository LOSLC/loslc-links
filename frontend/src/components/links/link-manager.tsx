  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex justify-between items-center">
        <div className="text-sm text-gray-600">Manage your shortened links</div>
        ...
        <div className="grid gap-4">
          {links.length === 0 ? (
            ...
            links.map((link) => (
              <Card
                key={link.id}
                className="shadow-sm border-foreground/50 hover:shadow-md transition-shadow"
              >
      ...
      {links.length > 0 && (
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-2">
          <div className="text-sm text-gray-600">
            Page {currentPage} • Showing {links.length} link
            {links.length !== 1 ? "s" : ""}
